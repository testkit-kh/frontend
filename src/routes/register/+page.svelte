<script lang="ts">
	...
	async function submit(event: SubmitEvent) {
		...
		if (!success) return;
		// Сразу после регистрации — знакомство: у волонтёра спрашиваем об
		// образовании, у ООПТ настраиваем границы территории. Дальше человека
		// ведёт гвард в layout (согласие, обучение, карта или кабинет).
